...
@section('contenido')
  <div class="card mt-2">
    <div class="card-body">
      <h3 class="card-title">Proveedor {{$laboratorio->razon}}</h3>
      <ul>
        <li>
            Razón Social: <strong> {{ $laboratorio->razon }} </strong>
        </li>
        <li>
            Numero de Contacto: <strong>{{ $laboratorio->telefono }}</strong>
        </li>
        <li>
            Email o Correo electronico: <strong>{{ $laboratorio->email }}</strong>
        </li>
        <li>
            Direccion: <strong>{{ $laboratorio->direccion }}</strong>
        </li>
    </ul>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body" style="margin: 0 auto;">
                  <h5>¿Seguro que desea eliminar el laboratorio?</h5>
              </div>
