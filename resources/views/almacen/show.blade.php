...
@section('contenido')
    ...
    <ul>
        <li>
            Codigo de almacen: <strong>{{ $almacen->id }}</strong>
        </li>
        <li>
            Razón Social: <strong> {{ $almacen->rac }} </strong>
        </li>
        <li>
            Numero de Contacto: <strong>{{ $almacen->temperatura }}</strong>
        </li>
        <li>
            Email o Correo electronico: <strong>{{ $almacen->detalle }}</strong>
        </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin: 0 auto;">
                    <h5>¿Seguro que desea eliminar el almacen?</h5>
                </div>
