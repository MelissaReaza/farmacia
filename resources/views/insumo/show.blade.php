...
<nav class="m-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Ver insumo</li>
    </ol>
  </nav>
    ...
    <div class="row">
      <div class="col">
        <div class="card-body m-3">
          <h5 class="card-title mb-2 h3">
            <a class="btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Atrás" href="{{ route('insumo.index') }}" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
                <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
              </svg></a>
             Revisión a detalle de: {{ $insumo->codigo }}</h5>

          <div class="row p-2 shadow bg-ligth border-radius rounded-4">
            <div class="col">
                <br>
                ...
                </svg> Código de médicamento: <strong> {{ $insumo->codigo }} </strong>                       
            <br>
            <br>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-capsule" viewBox="0 0 16 16">
              ...
              </svg> Nombre Comercial: <strong> {{ $insumo->nombre_comercial }} </strong>
            <br>
            <br>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-prescription2" viewBox="0 0 16 16">
              ...
              </svg> Número de lote: <strong>000{{ $insumo->lote_id }}</strong>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-building-check" viewBox="0 0 16 16">
              ...
              </svg> Número de Almacen: <strong>{{ $insumo->almacen_id }}</strong>
            <br>
            <br>
            ...
            <div class="col">
                <br>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bag-check" viewBox="0 0 16 16">
                      ...
                      </svg> Cantidad disponible: <strong>{{ $insumo->stock }}</strong>
                      <br>
                      <br>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                      ...
                      </svg> Precio de compra: <strong>{{ $insumo->precio }} Bs.</strong>
                    <br>
                    <br>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-calendar-plus" viewBox="0 0 16 16">
                  ...
                  </svg> Fecha de ingreso: <strong>{{ \Carbon\Carbon::parse($insumo->fecha_ingreso)->format('d/m/Y') }}</strong>
                  <br>
                  <br>
                  ...
                  </svg> Detalle: <strong>{{ $insumo->detalle }}</strong>
            </div>
          </div>
          <br>
          <p class="card-text">Revise las características del insumo. En caso que este requiera modificaciones, porfavor notificarlo a administración.</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin: 0 auto;">
                <h5>¿Seguro que desea eliminar el insumo?</h5>
            </div>
      ...
      <div class="col">
        <img src="{{ asset('img/insumo.png') }}" class="img-fluid rounded-start" alt="imagen general de insumos">
      </div>
    </div>
